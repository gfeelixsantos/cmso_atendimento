...
function buscaDados(funcionario) {
    ...
    const urlBuscaGuia = `https://ws1.soc.com.br/WebSoc/exportadados?parametro={'empresa':'76278','codigo':'186384','chave':'d2752ccec36a79403dcf','tipoSaida':'json','codigoSequencial':${funcionario.ficha},'empresaTrabalho':${funcionario.empresa}}`
